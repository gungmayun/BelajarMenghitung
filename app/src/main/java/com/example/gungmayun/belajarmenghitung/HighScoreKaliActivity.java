...
public class HighScoreKaliActivity extends AppCompatActivity {
    private ImageButton back;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_high_score_kali);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HighScoreKaliActivity.this, BelajarActivity.class);
    ...
    public void OnClick (View view){
            Intent intent = new Intent(HighScoreKaliActivity.this, PerkalianActivity.class);
        startActivity(intent);
    }
}
